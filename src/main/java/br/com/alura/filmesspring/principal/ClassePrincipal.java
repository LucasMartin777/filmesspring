...
public class ClassePrincipal {
    ...
    public void exibeMenu() {
        ...
        while (opcao != 0) {
            var menu = """
                    ...
                    10 - EpisodiosPorSerie
                    11 - Buscar eps a partir de uma data
    ...
    private void buscarEpisodioPorSerie() {
        ...
        if (serie.isPresent()) {
            ...
            for (int i = 1; i <= serieEncontrada.getTotalTemporadas(); i++) {
                var json = consumo.conexao(ENDERECO + serieEncontrada.getTitulo().replace(" ", "+") + "&season=" + i + API_KEY);
    ...
    private void buscarSeriesPorCategoria() {
        ...
        System.out.println("Series da Categoria " + seriesPorCategoria);
        seriesPorCategoria.forEach(System.out::println);
    }

    private void buscarSeriesPorNumeroDeTemporadas() {
        System.out.println("Qual o numero de temporadas maxima?");
